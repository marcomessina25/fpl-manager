# Counterfactual Error Attribution Report: Season 2023-24
...
|---|---:|---:|---:|
| `STARTING_STATE_ERROR` | 0 | 0 pts | 0.0% |
| `PREDICTION_ERROR` | 5 | 10 pts | 100.0% |
| `DECISION_ERROR` | 0 | 0 pts | 0.0% |
| `INTERACTION_ERROR` | 0 | 0 pts | 0.0% |
| `HARMLESS` | 0 | 0 pts | 0.0% |
